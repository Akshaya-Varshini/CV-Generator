...
label_skills = Label(window, text="Skills (Enter 1 skill per line)")
label_skills.pack()
...
label_experience = Label(window, text="Experience (One per line in format 'Job Title' : 'Job Description')")
